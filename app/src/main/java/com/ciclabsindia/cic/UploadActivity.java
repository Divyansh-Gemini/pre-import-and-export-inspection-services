            ...
            if (isConnectedToInternet())
            {
                ...
                try {
                    ...
                    reference.putFile(uri)
                            .addOnSuccessListener(taskSnapshot -> reference.getDownloadUrl().addOnSuccessListener(uri1 -> {
                                FileInfo fileInfo = new FileInfo(doc_name, uri1.toString());
                                ...
                                try{
                                    ...
                                    PyObject obj = pyObj.callAttr("getData", uri1.toString());
