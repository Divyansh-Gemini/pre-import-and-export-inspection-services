...
public class D_03_Locations extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View myView = inflater.inflate(R.layout.fragment_d_03_locations, container, false);
        ...
        editText1.setText(port_of_loading);
        editText2.setText(port_of_discharge);
        editText3.setText(final_destination);

        btn_next.setOnClickListener(v -> {
            port_of_loading = editText1.getText().toString().toUpperCase();
            port_of_discharge = editText2.getText().toString().toUpperCase();
            final_destination = editText3.getText().toString().toUpperCase();

            //##################### SENDING DATA TO NEXT FRAGMENT #####################
            D_04_GoodsDescription frg = new D_04_GoodsDescription();
