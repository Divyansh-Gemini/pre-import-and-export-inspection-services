...
public class C_05_Quantity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View myView = inflater.inflate(R.layout.fragment_c_05_quantity, container, false);
...
//        editText1.setText(total_no_of_bags);
//        editText2.setText(gross_weight);
//        editText3.setText(tare_weight);
//        editText4.setText(net_weight);

        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                total_no_of_bags = editText1.getText().toString().toUpperCase();
                gross_weight = editText2.getText().toString().toUpperCase();
                tare_weight = editText3.getText().toString().toUpperCase();
                net_weight = editText4.getText().toString().toUpperCase();

                //##################### SENDING DATA TO NEXT FRAGMENT #####################
                C_06_QualityCheck frg = new C_06_QualityCheck();
                Bundle b = new Bundle();
