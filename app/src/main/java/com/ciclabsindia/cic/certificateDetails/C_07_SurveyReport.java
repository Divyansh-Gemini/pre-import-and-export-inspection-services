...
public class C_07_SurveyReport extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View myView = inflater.inflate(R.layout.fragment_c_07_survey_report, container, false);
        ...
        editText1.setText(container_no);
        editText2.setText(container_size);
        editText3.setText(no_of_bags);
        editText4.setText(condition);

        btn_next.setOnClickListener(v -> {
            container_no = editText1.getText().toString().toUpperCase();
            container_size = editText2.getText().toString().toUpperCase();
            no_of_bags = editText3.getText().toString().toUpperCase();
            condition = editText4.getText().toString().toUpperCase();

            //##################### SENDING DATA TO NEXT FRAGMENT #####################
            C_08_Other frg = new C_08_Other();
