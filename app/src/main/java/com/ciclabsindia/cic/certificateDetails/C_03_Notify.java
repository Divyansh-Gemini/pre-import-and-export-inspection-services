...
public class C_03_Notify extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View myView = inflater.inflate(R.layout.fragment_c_03_notify, container, false);
        ...
        editText1.setText(notify_name);
        editText2.setText(notify_address);
        editText3.setText(notify_tel);
        editText4.setText(notify_fax);

        btn_next.setOnClickListener(v -> {
            notify_name = editText1.getText().toString().toUpperCase();
            notify_address = editText2.getText().toString().toUpperCase();
            notify_tel = editText3.getText().toString();
            notify_fax = editText4.getText().toString();

            //##################### SENDING DATA TO NEXT FRAGMENT #####################
            C_04_GoodsDescription frg = new C_04_GoodsDescription();
